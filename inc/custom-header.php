		...
		<style type="text/css" id="theme-header-css">
			...
			<?php if ($section_color_primary != MP_ARTWORK_BRAND_COLOR && $section_color_primary != '') { ?>
				...
				.page-wrapper:nth-child(4n+2) {
					...
					background: -moz-linear-gradient(-45deg, #1e5799 0%, #3023ae 2%, #c96dd8 100%); /* FF3.6-15 */
					background: -webkit-linear-gradient(-45deg, #1e5799 0%,#3023ae 2%,#c96dd8 100%); /* Chrome10-25,Safari5.1-6 */
					background: linear-gradient(135deg, #1e5799 0%,#3023ae 2%,#c96dd8 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
					filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#1e5799', endColorstr='#c96dd8',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
				}
			<?php }
